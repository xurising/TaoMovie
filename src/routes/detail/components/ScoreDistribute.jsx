        ...
        <div>
          <div className="distribute__item">
            ...
            <div className="distribute__btm">
              <div className="distribute__top" style={{width: '60%'}} />
            </div>
          </div>
          <div className="distribute__item">
            <Star  value={8} size={8} />
          ...
          <div className="distribute__item">
            <Star  value={6} size={8} />
            <div className="distribute__btm">
              <div className="distribute__top" style={{width: '7%'}} />
            </div>
          </div>
          <div className="distribute__item">
            <Star  value={4} size={8} />
            <div className="distribute__btm">
              <div className="distribute__top" style={{width: '2%'}} />
            </div>
          </div>
          <div className="distribute__item">
            <Star  value={2} size={8} />
            <div className="distribute__btm">
              <div className="distribute__top" style={{width: '1%'}} />
            </div>
          </div>
        </div>
      </div>
